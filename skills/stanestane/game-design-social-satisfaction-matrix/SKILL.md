...
Generate:
1. **Audit target** - what game, mode, or set of social elements is being reviewed
2. **Element map** - where each chosen element sits in the matrix
3. **Rationale** - why each element belongs there
4. **Risk and opportunity view** - what the matrix reveals about the current social landscape
5. **Improvement priorities** - what to fix, protect, redesign, add, or deprioritize
6. **Sweet-spot judgment** - where the design should aim to increase satisfaction without creating disproportionate social risk
