...
version: "1.0.0"
displayName: "Video Montage Maker — Combine Clips into One Video"
description: >
  create video clips into compiled montage video with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. social media creators use it for combining multiple clips into a single edited montage video — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-montage-maker` |
