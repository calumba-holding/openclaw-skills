...
version: "1.0.0"
displayName: "Video Caption Remover — Remove Hardcoded Captions from Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — remove the hardcoded captions from the bottom of this video — and get clean captionless videos back in 30-90 seconds. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI caption removal automatically. Ideal for content creators and video editors who want to strip burned-in captions before re-editing or re-publishing.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-caption-remover` |
