---
name: ai-video-editor-cinematic
version: "1.0.0"
displayName: "AI Video Editor Cinematic — Turn Raw Footage into Cinematic Videos"
description: >
  Turn a 2-minute handheld travel clip into 4K cinematic edited videos just by typing what you need. Whether it's transforming raw footage into cinematic-style films with AI color grading and cuts or quick social content, drop your raw video footage and describe the result you want. No timeline dragging, no export settings — 1-2 minutes from upload to download.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `ai-video-editor-cinematic` |
