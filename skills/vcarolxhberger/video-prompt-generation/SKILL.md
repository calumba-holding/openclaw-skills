...
version: "1.0.0"
displayName: "Video Prompt Generation — Generate Video Prompts from Text"
description: >
  Skip the learning curve of professional editing software. Describe what you want — generate a detailed video prompt for a 30-second product showcase with cinematic lighting — and get ready-to-use prompts back in 10-20 seconds. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI prompt generation automatically. Ideal for content creators who want structured video prompts without spending time writing detailed briefs.
