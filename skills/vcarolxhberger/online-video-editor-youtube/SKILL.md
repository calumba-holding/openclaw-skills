...
version: "1.0.0"
displayName: "Online Video Editor for YouTube — Edit and Export YouTube Videos"
description: >
  Turn a 10-minute YouTube vlog recording into 1080p YouTube-ready videos just by typing what you need. Whether it's editing and polishing videos for YouTube upload or quick social content, drop your video clips and describe the result you want. No timeline dragging, no export settings — 1-2 minutes from upload to download.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `online-video-editor-youtube` |
