...
name: hd-local-ai
version: "1.0.0"
displayName: "HD Local AI — Enhance Local Videos to HD"
description: >
  Get HD processed videos ready to post, without touching a single slider. Upload your local video files (MP4, MOV, AVI, MKV, up to 500MB), say something like "enhance and upscale this local video to HD without uploading to the cloud", and download 1080p MP4 when it's done. Built for content creators and video editors who move fast and want to improve local video quality without cloud uploads or privacy concerns.
