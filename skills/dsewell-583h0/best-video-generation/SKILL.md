---
name: best-video-generation
version: "1.0.0"
displayName: "Best Video Generation — Generate Videos from Text Prompts"
description: >
  Turn a short text prompt describing a sunset timelapse over a city into 1080p AI generated videos just by typing what you need. Whether it's generating videos from text prompts or images or quick social content, drop your text prompts and describe the result you want. No timeline dragging, no export settings — 1-2 minutes from upload to download.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `best-video-generation` |
