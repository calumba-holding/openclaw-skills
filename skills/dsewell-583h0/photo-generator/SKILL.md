...
version: "1.0.0"
displayName: "Photo Generator — Generate Photos from Text Prompts"
description: >
  Get AI generated photos ready to post, without touching a single slider. Upload your text or images (JPG, PNG, WEBP, HEIC, up to 200MB), say something like "generate a realistic photo of a product on a white background", and download 1080p MP4 when it's done. Built for marketers, content creators, designers who move fast and want custom photos without a camera or photo shoot.
