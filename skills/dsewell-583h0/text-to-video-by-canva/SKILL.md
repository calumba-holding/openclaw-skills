---
name: text-to-video-by-canva
version: "1.0.0"
displayName: "Text to Video by Canva — Convert Text into Shareable Videos"
description: >
  Get text-based videos ready to post, without touching a single slider. Upload your text prompts (TXT, DOCX, PDF, copied text, up to 200MB), say something like "turn this blog post intro into a 30-second video with visuals and music", and download 1080p MP4 when it's done. Built for marketers who move fast and want to create videos without filming or editing experience.
