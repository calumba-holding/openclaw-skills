...
var require_dist = __commonJS({
  "packages/shared/dist/index.js"(exports2) {
    ...
    __exportStar(require_hashing(), exports2);
    __exportStar(require_ids(), exports2);
    __exportStar(require_approval_binding(), exports2);
    __exportStar(require_checkpoint(), exports2);
    __exportStar(require_compiled_graph(), exports2);
    __exportStar(require_policy_artifact(), exports2);
    __exportStar(require_proof_bundle(), exports2);
    __exportStar(require_receipt(), exports2);
    __exportStar(require_run_manifest(), exports2);
    __exportStar(require_step_grant(), exports2);
    __exportStar(require_workflow(), exports2);
    __exportStar(require_time(), exports2);
    __exportStar(require_approvals(), exports2);
    __exportStar(require_bridges(), exports2);
    __exportStar(require_classifier(), exports2);
    __exportStar(require_compiler(), exports2);
    __exportStar(require_grants(), exports2);
    __exportStar(require_ledger(), exports2);
    __exportStar(require_receipts(), exports2);
    __exportStar(require_replay(), exports2);
    __exportStar(require_workflow2(), exports2);
  }
});
...
var require_main = __commonJS({
  "packages/elevated/dist/main.js"(exports2) {
    ...
    __exportStar(require_local_transport_guard(), exports2);
    __exportStar(require_server(), exports2);
    __exportStar(require_verify_approval(), exports2);
    __exportStar(require_runner(), exports2);
    __exportStar(require_resolve2(), exports2);
    __exportStar(require_schema(), exports2);
    __exportStar(require_elevated_openclaw_client(), exports2);
  }
});
...
// packages/runtime/dist/cli/toolflow.js
var require_toolflow = __commonJS({
  "packages/runtime/dist/cli/toolflow.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.main = main;
    var node_fs_1 = require("node:fs");
    ...
    async function main(argv) {
      ...
      try {
        ...
        if (command === "dry-run")
          return print((0, run_service_1.dryRun)(required(args[0], "workflow path")));
        if (command === "run")
          return print(await (0, run_service_1.runWorkflow)(required(args[0], "workflow path")));
        if (command === "resume")
          return print(await (0, run_service_1.resumeWorkflow)(required(args[0], "run id")));
        if (command === "approve")
          return print((0, run_service_1.approveRunStep)(required(args[0], "run id"), required(args[1], "step id"), args[2] ?? "operator"));
        if (command === "cancel")
          return print((0, run_service_1.cancelRun)(required(args[0], "run id"), args[1] ?? "operator_cancelled"));
        if (command === "recover")
          return print((0, recovery_service_1.recoverRun)(new store_1.LedgerStore((0, resolve_1.resolveConfig)().ledgerRoot), required(args[0], "run id")));
        if (command === "receipts")
          return print((0, run_service_1.getRunReceipts)(args[0]));
        if (command === "status")
          return print((0, run_service_1.getRunStatus)(args[0]));
        if (command === "inspect")
          return print((0, run_service_1.inspectRun)(args[0]));
        if (command === "doctor")
          return doctor();
    ...
    function validate(args) {
      ...
      const result = (0, compile_1.compileWorkflowFile)(workflowPath);
    ...
    function doctor() {
      ...
      print({
        ...
        ledgerExists: (0, node_fs_1.existsSync)(config.ledgerRoot),
        ...
        recovery: (0, recovery_service_1.recoveryStatus)()
      });
    }
    function help() {
...
Ledger: ${(0, node_path_1.resolve)("data/ledger")}`);
    }
...
var toolflow_1 = require_toolflow();
(0, toolflow_1.main)(process.argv.slice(2)).catch((error) => {
  console.error(error.message);
  process.exitCode = 1;
});
