...
Maton proxies requests to `app.clio.com` and automatically injects your OAuth token.
...
- Access is scoped to matters, contacts, activities, tasks, documents, and billing within the connected Clio account.
