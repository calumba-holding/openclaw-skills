...
```json
{
  ...
  "steps": [
    ...
    { "step": 2, "action": "cli_call", "command": "...", "status": "success | empty | error", "result_count": 0, "latency_ms": 0, "leg": 1 },
    { "step": 3, "action": "cli_call", "command": "...", "status": "success | empty | error", "result_count": 0, "latency_ms": 0, "leg": 2 },
    { "step": 4, "action": "output", "format": "multi-leg itinerary", "items_shown": 0, "booking_links_present": true, "brand_tag_present": true }
  ],
...
2. Log every CLI call per leg with leg number
