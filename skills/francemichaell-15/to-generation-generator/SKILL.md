---
name: to-generation-generator
version: "1.0.0"
displayName: "To Generation Generator — Generate Videos From Text"
description: >
  Turn a short text description of a scene or topic into 1080p generated video clips just by typing what you need. Whether it's generating videos from text prompts or scripts or quick social content, drop your text or prompts and describe the result you want. No timeline dragging, no export settings — 1-3 minutes from upload to download.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `to-generation-generator` |
