---
name: editing-text-generator
version: "1.0.0"
displayName: "Editing Text Generator — Generate Text Overlays for Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — generate on-screen editing instructions as text overlays synced to the video — and get text-overlaid videos back in 30-60 seconds. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI text overlay generation automatically. Ideal for content creators who want to add dynamic text and editing cues to videos without manual titling work.
