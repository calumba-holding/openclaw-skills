---
name: ai-subtitle-jellyfin
version: "1.0.0"
displayName: "AI Subtitle Jellyfin — Generate Subtitles for Jellyfin Videos"
description: >
  generate video files into subtitled video files with this skill. Works with MP4, MKV, AVI, MOV files up to 500MB. Jellyfin media server users use it for adding AI-generated subtitles to Jellyfin media files — processing takes 1-3 minutes on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `ai-subtitle-jellyfin` |
