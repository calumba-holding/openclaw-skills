...
description: >
  家庭培养协作官。安装后可直接说“我想给孩子建一个每周培养计划”开始使用。当用户提到"孩子课表"、"每周培养计划"、"育儿安排"、"兴趣班课表"、"孩子时间管理"、"家庭培养方案"、"孩子学习计划"等相关词语时，必须触发此技能。
...
首次使用时，Skill 会逐轮收集孩子画像、家庭约束、培养目标和执行偏好，然后生成第一版课表。
如果你已经有孩子课表、家庭作息或孩子画像文档，直接上传即可，Skill 会尽量跳过提问，直接生成第一版结果。
