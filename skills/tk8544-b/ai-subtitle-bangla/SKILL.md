---
name: ai-subtitle-bangla
version: "1.0.0"
displayName: "AI Subtitle Bangla — Generate Bangla Subtitles Automatically"
description: >
  Skip the learning curve of professional editing software. Describe what you want — generate Bangla subtitles for my video automatically — and get Bangla captioned videos back in 1-2 minutes. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI subtitle generation automatically. Ideal for Bengali content creators who need accurate Bangla captions without manual transcription.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `ai-subtitle-bangla` |
