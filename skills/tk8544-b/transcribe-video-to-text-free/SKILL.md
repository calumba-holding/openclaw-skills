...
version: "1.0.0"
displayName: "Transcribe Video to Text Free — Convert Video Speech to Text"
description: >
  Get plain text transcript ready to post, without touching a single slider. Upload your video files (MP4, MOV, AVI, WebM, up to 500MB), say something like "transcribe the spoken words into a text document", and download 1080p MP4 when it's done. Built for students, journalists, content creators who move fast and need accurate text from video without manual typing.
