---
name: video-converter-mov-to-mp4
version: "1.0.0"
displayName: "Video Converter MOV to MP4 — Convert MOV Files to MP4"
description: >
  Get converted MP4 files ready to post, without touching a single slider. Upload your MOV video files (MOV, MP4, AVI, WebM, up to 500MB), say something like "convert this MOV file to MP4 so I can upload it to YouTube", and download 1080p MP4 when it's done. Built for iPhone users, Mac creators, video editors who move fast and need MOV files converted to MP4 for uploading to social platforms or editing software.
