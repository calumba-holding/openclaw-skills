...
version: "1.0.0"
displayName: "Subtitle Generator for Video — Generate and Embed Video Subtitles"
description: >
  Skip the learning curve of professional editing software. Describe what you want — add subtitles in English and Spanish to my video — and get captioned videos back in 30-60 seconds. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles subtitle generation automatically. Ideal for YouTubers and content creators who need accurate captions without manual transcription.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `subtitle-generator-for-video` |
