---
name: video-editing-ai-best
version: "1.0.0"
displayName: "Video Editing AI Best — Edit and Export Polished Videos"
description: >
  Turn a 3-minute unedited screen recording into 1080p polished edited clips just by typing what you need. Whether it's automatically editing raw footage into a ready-to-share video or quick social content, drop your raw video footage and describe the result you want. No timeline dragging, no export settings — 1-2 minutes from upload to download.
...
# Video Editing AI Best — Edit and Export Polished Videos
...
Here's a typical use: you send a a 3-minute unedited screen recording, ask for cut out silences, add transitions, and export a clean final video, and about 1-2 minutes later you've got a MP4 file ready to download. The whole thing runs at 1080p by default.

One thing worth knowing — shorter clips under 2 minutes process significantly faster and give more precise AI results.

## Matching Input to Actions

User prompts referencing video editing ai best, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
- `X-Skill-Source`: `video-editing-ai-best`
