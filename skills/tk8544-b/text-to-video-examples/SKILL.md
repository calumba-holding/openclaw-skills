...
version: "1.0.0"
displayName: "Text to Video Examples — Convert Text into Video Clips"
description: >
  Turn a 3-sentence product description into 1080p generated video clips just by typing what you need. Whether it's generating videos from written scripts or prompts or quick social content, drop your text prompts and describe the result you want. No timeline dragging, no export settings — 1-2 minutes from upload to download.
