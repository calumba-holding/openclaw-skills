...
version: "1.0.0"
displayName: "Sora Video Generator — Generate Videos from Text Prompts"
description: >
  generate text prompts into AI generated videos with this skill. Works with TXT, PNG, JPG, MP4 files up to 200MB. content creators use it for generating short videos from text prompts — processing takes 1-3 minutes on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `sora-video-generator` |
