# japan-korea-policy-query

[![OpenClaw Skill](https://img.shields.io/badge/OpenClaw-Skill-blue.svg)](https://clawhub.ai)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![Version](https://img.shields.io/badge/version-1.0.0-green.svg)](https://clawhub.ai/skills/japan-korea-policy-query)
...
日韩市场政策查询Skill - 提供日韩市场政策、法规、投资环境的智能查询和分析
...
```javascript
const PolicyQuery = require('japan-korea-policy-query');
...
### 运行测试
```bash
cd node_modules/japan-korea-policy-query
npm test
```
