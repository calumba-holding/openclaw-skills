...
[![Version](https://img.shields.io/badge/version-1.0.0-green.svg)](https://clawhub.ai/skills/india-policy-query)
...
印度市场政策查询Skill - 提供印度市场政策、法规、投资环境的智能查询和分析
...
```javascript
const PolicyQuery = require('india-policy-query');
...
### 运行测试
```bash
cd node_modules/india-policy-query
npm test
```
