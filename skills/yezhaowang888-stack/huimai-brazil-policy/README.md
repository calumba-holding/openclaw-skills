...
[![Version](https://img.shields.io/badge/version-1.0.0-green.svg)](https://clawhub.ai/skills/brazil-policy-query)
...
巴西市场政策查询Skill - 提供巴西市场政策、法规、投资环境的智能查询和分析
...
```javascript
const PolicyQuery = require('brazil-policy-query');
...
### 运行测试
```bash
cd node_modules/brazil-policy-query
npm test
```
