---
name: add-music-to-video-app
version: "1.0.0"
displayName: "Add Music to Video App — Add Music and Export Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — add upbeat background music to my video and fade it out at the end — and get music-backed videos back in 20-40 seconds. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI music addition automatically. Ideal for TikTok creators who want to add music to videos quickly without using complex editing software.
