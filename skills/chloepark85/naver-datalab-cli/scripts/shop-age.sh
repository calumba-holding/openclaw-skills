#!/usr/bin/env bash
# shop-age.sh — 분야의 연령대별 트렌드 (10/20/30/40/50/60).
#
# Usage:
#   shop-age.sh --start YYYY-MM-DD --end YYYY-MM-DD --time-unit (date|week|month) \
#               --category 50000000
set -euo pipefail
...
resp=$(datalab_post "shopping/category/age" "$body")
