...
name: clock-video
version: "1.0.0"
displayName: "Clock Video — Add Clock Overlays to Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — add an animated clock countdown to the intro and timestamp overlays throughout — and get clock-overlaid videos back in 30-60 seconds. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI clock overlay creation automatically. Ideal for content creators, marketers, educators who want to add clock visuals or countdown timers without manual editing.
