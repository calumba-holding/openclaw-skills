---
name: video-editor-with-ai-image
version: "1.0.0"
displayName: "Video Editor with AI Image — Turn Images into Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — combine these images into a smooth video with transitions and background music — and get AI-generated video back in 30-60 seconds. Upload JPG, PNG, MP4, MOV files up to 200MB, and the AI handles AI image-to-video creation automatically. Ideal for marketers and content creators who want to create videos from images without complex editing software.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-editor-with-ai-image` |
