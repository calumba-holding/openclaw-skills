...
version: "1.0.0"
displayName: "Image to Video Long Duration — Convert Images into Extended Videos"
description: >
  Get extended video clips ready to post, without touching a single slider. Upload your images (JPG, PNG, WEBP, HEIC, up to 200MB), say something like "turn this image into a 2-minute video with smooth motion and background music", and download 1080p MP4 when it's done. Built for marketers, content creators, social media managers who move fast and want to create longer video content from photos without filming footage.
