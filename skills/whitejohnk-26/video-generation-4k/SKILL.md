...
version: "1.0.0"
displayName: "Video Generation 4K — Generate 4K Videos from Text"
description: >
  Get 4K AI videos ready to post, without touching a single slider. Upload your text prompts (MP4, MOV, WebM, AVI, up to 500MB), say something like "generate a 10-second 4K video of a futuristic city at night with neon lights", and download 4K MP4 when it's done. Built for content creators, marketers, filmmakers who move fast and need high-quality 4K video without cameras or editing software.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-generation-4k` |
