...
version: "1.0.0"
displayName: "Add Text to Video — Overlay Text and Export Videos"
description: >
  Turn a 60-second product demo video into 1080p text-overlaid videos just by typing what you need. Whether it's adding titles and captions to social media videos or quick social content, drop your video clips and describe the result you want. No timeline dragging, no export settings — 20-40 seconds from upload to download.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `add-text-to-video` |
