---
name: video-hook-generator-free
version: "1.0.0"
displayName: "Video Hook Generator Free — Generate Hooks for Your Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — generate a compelling opening hook for my video to stop viewers from scrolling — and get hook-ready clips back in 20-40 seconds. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI hook generation automatically. Ideal for TikTok creators who want to stop viewer drop-off in the first 3 seconds without hiring an editor.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-hook-generator-free` |
