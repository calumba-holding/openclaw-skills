...
version: "1.0.0"
displayName: "Online Subtitle Generator — Generate and Embed Video Subtitles"
description: >
  generate video files into captioned video files with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. YouTubers, content creators, educators use it for adding subtitles to YouTube and social media videos — processing takes 30-60 seconds on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `online-subtitle-generator` |
