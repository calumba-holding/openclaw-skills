...
version: "1.0.0"
displayName: "Video to Subtitle Generator — Auto-Generate Subtitles for Videos"
description: >
  Turn a 3-minute tutorial video recorded on a laptop into 1080p captioned video files just by typing what you need. Whether it's adding accurate subtitles to videos for YouTube or social media or quick social content, drop your video files and describe the result you want. No timeline dragging, no export settings — 30-60 seconds from upload to download.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-to-subtitle-generator` |
