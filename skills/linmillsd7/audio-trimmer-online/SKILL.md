...
version: "1.0.0"
displayName: "Audio Trimmer Online — Trim and Export Audio Clips"
description: >
  Skip the learning curve of professional editing software. Describe what you want — trim the first 15 seconds and cut everything after the 2-minute mark — and get trimmed audio clips back in 20-40 seconds. Upload MP3, WAV, AAC, M4A files up to 200MB, and the AI handles audio trimming editing automatically. Ideal for podcasters, content creators, students who want to cut audio quickly without installing desktop software.
