...
version: "1.0.0"
displayName: "Video Editing with Generative AI — Edit and Export AI Videos"
description: >
  Get AI-edited videos ready to post, without touching a single slider. Upload your raw video footage (MP4, MOV, AVI, WebM, up to 500MB), say something like "remove silences, add b-roll transitions, and generate a title card", and download 1080p MP4 when it's done. Built for content creators and marketers who move fast and want professional edits without learning complex editing software.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-editing-with-generative-ai` |
