...
version: "1.0.0"
displayName: "Windows Video Editor — Edit and Export Video Clips"
description: >
  Get edited MP4 clips ready to post, without touching a single slider. Upload your raw video clips (MP4, MOV, AVI, WMV, up to 500MB), say something like "trim the pauses, add transitions, and export as MP4", and download 1080p MP4 when it's done. Built for casual creators and Windows users who move fast and want quick edits without learning complex software.
