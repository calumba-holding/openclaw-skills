---
name: video-editor-with-ai-effects
version: "1.0.0"
displayName: "Video Editor with AI Effects — Apply AI Effects to Videos"
description: >
  Turn a 90-second smartphone recording into 1080p AI-enhanced videos just by typing what you need. Whether it's applying AI visual effects to raw footage for social media or quick social content, drop your raw video clips and describe the result you want. No timeline dragging, no export settings — 1-2 minutes from upload to download.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-editor-with-ai-effects` |
