...
version: "1.0.0"
displayName: "Transcript Generator — Convert Video Speech to Text"
description: >
  Skip the learning curve of professional editing software. Describe what you want — generate a full text transcript of this interview video — and get text transcript files back in 30-90 seconds. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI transcript generation automatically. Ideal for content creators, journalists, students who need accurate text from video without manual transcription.
