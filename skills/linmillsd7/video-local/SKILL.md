...
name: video-local
version: "1.0.0"
displayName: "Video Local — Edit and Export Local Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — trim the intro, add background music, and export for YouTube — and get edited local videos back in 1-2 minutes. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI local video editing automatically. Ideal for content creators and casual editors who want to edit videos stored on their device quickly without complex software.
