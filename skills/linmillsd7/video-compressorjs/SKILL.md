...
version: "1.0.0"
displayName: "Video Compressor JS — Compress and Export Smaller Videos"
description: >
  compress video files into compressed MP4 files with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. content creators, developers, marketers use it for reducing video file size for sharing or uploading — processing takes 20-60 seconds on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-compressorjs` |
