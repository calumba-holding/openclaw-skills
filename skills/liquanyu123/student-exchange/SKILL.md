...
displayName: "Student Exchange Flights — Study Abroad, Exchange Program Travel"
description: "Search for student exchange program flights and study abroad travel. Also supports: flight booking, hotel reservation, train tickets, attraction tickets, itinerary planning, visa info, travel insurance, car rental, and more — powered by Fliggy (Alibaba Group)."
version: "3.2.0"
...
|------------|----------------------|
| "student exchange" / "交换生出行" | --sort-type 3 |
| "study abroad direct" / "留学直飞" | --journey-type 1 --sort-type 3 |
