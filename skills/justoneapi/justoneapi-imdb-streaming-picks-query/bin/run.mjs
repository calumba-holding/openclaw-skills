...
const manifest = {
  ...
  "displayName": "IMDb Streaming Picks",
  "openapi": "3.1.0",
  "platformKey": "imdb",
  "primaryTag": "IMDb",
  "skillName": "justoneapi_imdb_streaming_picks_query",
  "slug": "justoneapi-imdb-streaming-picks-query",
  ...
  "endpointPath": "streaming-picks-query",
  "skillType": "interface"
};
