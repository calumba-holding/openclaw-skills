...
const manifest = {
  ...
  "displayName": "IMDb Box Office Summary",
  "openapi": "3.1.0",
  "platformKey": "imdb",
  "primaryTag": "IMDb",
  "skillName": "justoneapi_imdb_title_box_office_summary",
  "slug": "justoneapi-imdb-title-box-office-summary",
  ...
  "endpointPath": "title-box-office-summary",
  "skillType": "interface"
};
