---
name: image-to-video-local-ai
version: "1.0.0"
displayName: "Image to Video Local AI — Convert Images into Video Clips"
description: >
  convert still images into animated video clips with this skill. Works with JPG, PNG, WEBP, BMP files up to 200MB. creators and developers use it for converting still photos into video clips using a local AI model — processing takes 1-3 minutes on cloud GPUs and you get 1080p MP4 files.
