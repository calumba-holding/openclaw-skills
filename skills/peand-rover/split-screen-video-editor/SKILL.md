...
version: "1.0.0"
displayName: "Split Screen Video Editor — Combine Clips Into One Video"
description: >
  Skip the learning curve of professional editing software. Describe what you want — place both clips side by side in a 50/50 split screen layout — and get split screen video back in 30-60 seconds. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles split screen layout automatically. Ideal for YouTubers, TikTok creators, content creators who want to compare footage or show reactions without complex editing software.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `split-screen-video-editor` |
