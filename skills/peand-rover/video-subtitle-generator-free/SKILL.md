---
name: video-subtitle-generator-free
version: "1.0.0"
displayName: "Video Subtitle Generator Free — Generate and Burn In Subtitles"
description: >
  add video files into captioned video files with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. YouTubers and content creators use it for adding subtitles to videos without paid software — processing takes 30-60 seconds on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-subtitle-generator-free` |
