---
name: best-free-video-editing-software
version: "1.0.0"
displayName: "Best Free Video Editing Software — Edit and Export Finished Videos"
description: >
  edit raw video clips into polished edited clips with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. YouTubers and content creators use it for editing raw footage into a finished video without paid software — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
...
- "editing raw footage into a finished video without paid software for YouTubers and content creators"
...
# Best Free Video Editing Software — Edit and Export Finished Videos
...
A quick example: upload a 3-minute unedited screen recording, type "trim the pauses, add transitions, and export a clean final cut", and you'll get a 1080p MP4 back in roughly 1-2 minutes. All rendering happens server-side.

Worth noting: shorter clips under 2 minutes process significantly faster and give cleaner AI cut results.

## Matching Input to Actions

User prompts referencing best free video editing software, aspect ratio, text overlays, or audio tracks get routed to the corresponding action via keyword and intent classification.
...
- `X-Skill-Source`: `best-free-video-editing-software`
