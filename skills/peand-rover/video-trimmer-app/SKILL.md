...
version: "1.0.0"
displayName: "Video Trimmer App — Trim and Export Clean Videos"
description: >
  trim video clips into trimmed video clips with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. content creators use it for cutting unwanted sections from raw video footage — processing takes 20-40 seconds on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-trimmer-app` |
