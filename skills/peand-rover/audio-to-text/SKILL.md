...
name: audio-to-text
version: "1.0.0"
displayName: "Audio to Text — Convert Audio into Captioned Video"
description: >
  Skip the learning curve of professional editing software. Describe what you want — transcribe this audio and add the text as captions on screen — and get captioned video files back in 30-60 seconds. Upload MP3, MP4, WAV, M4A files up to 500MB, and the AI handles speech to text transcription automatically. Ideal for podcasters, content creators, educators who need spoken words turned into readable text without manual typing.
