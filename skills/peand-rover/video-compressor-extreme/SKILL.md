...
version: "1.0.0"
displayName: "Video Compressor Extreme — Compress and Export Smaller Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — compress this video to under 100MB while keeping the best possible quality — and get compressed MP4 files back in 1-3 minutes. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles extreme video compression automatically. Ideal for content creators, marketers, students who need to shrink large video files without losing noticeable quality.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-compressor-extreme` |
