---
name: video-editing-ai-jobs
version: "1.0.0"
displayName: "Video Editing AI Jobs — Automate and Export Edited Videos"
description: >
  Get edited video files ready to post, without touching a single slider. Upload your raw video footage (MP4, MOV, AVI, WebM, up to 500MB), say something like "cut out silences, add transitions, and export a clean final cut", and download 1080p MP4 when it's done. Built for freelance video editors who move fast and want to complete editing jobs faster without manual timeline work.
