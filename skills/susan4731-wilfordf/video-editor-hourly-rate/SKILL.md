---
name: video-editor-hourly-rate
version: "1.0.0"
displayName: "Video Editor Hourly Rate — Edit Videos Without Hourly Fees"
description: >
  edit raw footage into polished edited clips with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. freelancers and small business owners use it for getting professional edits done without hiring a video editor by the hour — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-editor-hourly-rate` |
