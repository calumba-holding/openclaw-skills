---
name: google-video-editor
version: "1.0.0"
displayName: "Google Video Editor — Edit and Export Polished Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — trim the footage, add transitions, and include background music — and get edited MP4 videos back in 1-2 minutes. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI video editing automatically. Ideal for casual creators and marketers who want quick edits without learning complex software like Premiere.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `google-video-editor` |
