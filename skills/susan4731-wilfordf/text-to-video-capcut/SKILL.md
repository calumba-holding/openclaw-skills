---
name: text-to-video-capcut
version: "1.0.0"
displayName: "Text to Video CapCut — Convert Text Scripts Into Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — turn this script into a 30-second video with visuals and background music — and get AI-generated videos back in 1-2 minutes. Upload TXT, DOCX, PDF, SRT files up to 200MB, and the AI handles AI video creation automatically. Ideal for TikTok creators who want to create videos from text without filming or editing manually.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `text-to-video-capcut` |
