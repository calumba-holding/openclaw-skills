...
version: "1.0.0"
displayName: "Video Editing with AI App — Edit and Export Polished Videos"
description: >
  Skip the learning curve of professional editing software. Describe what you want — trim the pauses, add transitions, and overlay background music — and get edited video clips back in 1-2 minutes. Upload MP4, MOV, AVI, WebM files up to 500MB, and the AI handles AI-powered video editing automatically. Ideal for content creators who want quick professional edits without learning complex software.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-editing-with-ai-app` |
