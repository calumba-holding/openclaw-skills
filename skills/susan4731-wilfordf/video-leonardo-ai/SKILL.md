...
version: "1.0.0"
displayName: "Video Leonardo AI — Generate Videos from Images"
description: >
  Skip the learning curve of professional editing software. Describe what you want — generate a 10-second cinematic video from this image of a forest at sunset — and get AI generated videos back in 1-3 minutes. Upload JPG, PNG, WEBP, MP4 files up to 200MB, and the AI handles AI video generation automatically. Ideal for content creators who want to create videos without filming or editing skills.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-leonardo-ai` |
