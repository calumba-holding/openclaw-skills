...
version: "1.0.0"
displayName: "Generator Online — Create and Export Videos Online"
description: >
  generate text or media into ready-to-share videos with this skill. Works with MP4, MOV, JPG, PNG files up to 500MB. marketers, content creators, small business owners use it for generating videos from text or images online without software — processing takes 1-2 minutes on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `generator-online` |
