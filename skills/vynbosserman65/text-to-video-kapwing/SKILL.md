...
version: "1.0.0"
displayName: "Text to Video Kapwing — Convert Text Into Shareable Videos"
description: >
  Get text-based videos ready to post, without touching a single slider. Upload your text prompts (TXT, DOCX, MP4, MOV, up to 500MB), say something like "turn this text into a short video with visuals and captions", and download 1080p MP4 when it's done. Built for content creators and marketers who move fast and want to turn blog posts or scripts into videos without recording footage.
