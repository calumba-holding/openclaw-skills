---
name: kirk-ai-subtitle
version: "1.0.0"
displayName: "Kirk AI Subtitle — Generate and Embed Video Subtitles"
description: >
  add video files into captioned video files with this skill. Works with MP4, MOV, AVI, WebM files up to 500MB. content creators and YouTubers use it for adding AI-generated subtitles to videos automatically — processing takes 30-60 seconds on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `kirk-ai-subtitle` |
