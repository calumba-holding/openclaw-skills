---
name: video-generator-cartoon-for-beginners
version: "1.0.0"
displayName: "Video Generator Cartoon for Beginners — Create Cartoon Videos with AI"
description: >
  Get animated cartoon videos ready to post, without touching a single slider. Upload your text or images (JPG, PNG, MP4, GIF, up to 200MB), say something like "turn my story idea into a 30-second cartoon video with animated characters", and download 1080p MP4 when it's done. Built for beginners and first-time creators who move fast and want to make cartoon videos without learning complex animation software.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-generator-cartoon-for-beginners` |
