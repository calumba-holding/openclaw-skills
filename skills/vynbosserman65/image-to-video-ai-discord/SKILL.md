---
name: image-to-video-ai-discord
version: "1.0.0"
displayName: "Image to Video AI Discord — Convert Images into Discord Videos"
description: >
  convert still images into animated video clips with this skill. Works with JPG, PNG, WEBP, GIF files up to 200MB. Discord community members use it for converting static images into shareable Discord videos — processing takes 30-60 seconds on cloud GPUs and you get 1080p MP4 files.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `image-to-video-ai-discord` |
