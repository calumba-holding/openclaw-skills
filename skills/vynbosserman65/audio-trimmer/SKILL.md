...
name: audio-trimmer
version: "1.0.0"
displayName: "Audio Trimmer — Trim and Export Audio Clips"
description: >
  trim audio files into trimmed audio clips with this skill. Works with MP4, MOV, MP3, WAV files up to 500MB. podcasters, content creators, students use it for removing unwanted sections from audio recordings — processing takes 20-40 seconds on cloud GPUs and you get 1080p MP4 files.
