---
name: video-maker-cartoon-free
version: "1.0.0"
displayName: "Video Maker Cartoon Free — Create Animated Cartoon Videos Free"
description: >
  Turn five character sketches and a short story script into 1080p animated cartoon videos just by typing what you need. Whether it's creating free animated cartoon videos from images or scripts or quick social content, drop your images or text and describe the result you want. No timeline dragging, no export settings — 1-2 minutes from upload to download.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `video-maker-cartoon-free` |
