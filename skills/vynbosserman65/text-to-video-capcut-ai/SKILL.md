---
name: text-to-video-capcut-ai
version: "1.0.0"
displayName: "Text To Video CapCut AI — Convert Text Into AI Videos"
description: >
  Get AI generated videos ready to post, without touching a single slider. Upload your text prompts (TXT, DOCX, MP4, MOV, up to 200MB), say something like "turn this script into a 30-second video with visuals and background music", and download 1080p MP4 when it's done. Built for TikTok creators who move fast and want to create videos without filming or editing manually.
...
| Header | Value |
|--------|-------|
| `X-Skill-Source` | `text-to-video-capcut-ai` |
